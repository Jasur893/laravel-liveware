    ...
    <div class="sm:w-8/12 pl-0 p-5">
        <div class="space-y-2">
            <div class="flex items-center space-x-4 justify-between">
                ...
                <div wire:click="resetCounter"
                    class="bg-gray-500 shadow-lg shadow- shadow-gray-600 text-white cursor-pointer px-3 text-center justify-center items-center py-1 rounded-xl flex space-x-2 flex-row">
                    Reset
                </div>
            </div>
        </div>
